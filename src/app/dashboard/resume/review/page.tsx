  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <p className="text-sm text-slate-400">
        <Link href="/dashboard/resume" className="hover:underline hover:text-white transition-colors">
          Resume
        </Link>
      </p>
      <h1 className="text-2xl font-semibold text-white mt-1">Review what we found</h1>
