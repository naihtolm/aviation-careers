    ...
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <IssueSection
          ...
          renderItem={(j) => (
            <Link href={`/admin/jobs?q=${encodeURIComponent(j.title)}`} className="text-blue-600 hover:underline">
              {j.title}
            </Link>
          )}
        />
        ...
        <IssueSection
          ...
          renderItem={(r) => (
            <Link href="/admin/jobs/review" className="text-blue-600 hover:underline">
