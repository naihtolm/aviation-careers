    ...
    <div className="space-y-8">
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <StatCard label="Active jobs" value={stats.activeJobs} sub={`${stats.totalJobs} total`} />
          <StatCard label="New jobs (7d)" value={stats.newJobsThisWeek} />
          <StatCard label="Companies" value={stats.totalCompanies} />
          <StatCard label="Job seekers" value={stats.totalJobSeekers} sub={`+${stats.newSeekersThisWeek} this week`} />
