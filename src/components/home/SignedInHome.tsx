...
// The full homepage -- exactly what every visitor used to see regardless
// of auth state, before the homepage became gated. Now only rendered for
// signed-in users; see GatedHome.tsx for what a signed-out visitor gets
// instead.
export function SignedInHome({
  ...
  companies: any[];
  airports: any[];
  stats: { jobCount: number; companyCount: number; airportCount: number; newJobsThisWeek: number };
  sectors: any[];
}) {
  return (
    <div>
